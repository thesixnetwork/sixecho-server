...
def insert_mysql(Session, api_key_id=None, uid=None, body=None):
    ...
    ahash = HashImage(id=average_hash,hash_type="ahash",digital_content_id=uid) 
    phash = HashImage(id=phash,hash_type="phash",digital_content_id=uid) 
    dhash = HashImage(id=dhash,hash_type="dhash",digital_content_id=uid) 
    whash = HashImage(id=whash,hash_type="whash",digital_content_id=uid) 
    session.add(ahash)
    session.add(phash)
    session.add(dhash)
    session.add(whash)
